...
//fallbackSrc是什么?这是一个图片的内容,用base64加密过后的;这个给到图片的fallback属性上,用作显示不出来时候的备胎;
//因为有的时候后端返回的数据会烂掉;可能是过期,或者没处理好;
    ...
    <List.Item key={nft.token_id}>
      ...
      >
        <Image
          ...
          width="100%"
          height={200}
          fallback={fallbackSrc}//这是个备胎;
          placeholder={<Skeleton active />}//图片在载入过程中展示skeleton;
        />
      </Card>
    </List.Item>
  );
